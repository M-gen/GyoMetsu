...
{
    public class PlaneSprite : ISprite
    {
        public Emugen.Image.Primitive.Rect Rect;
        public Emugen.Image.Primitive.Color Color;
        public Emugen.OpenTK.View.IView view;

        public PlaneSprite(Emugen.Image.Primitive.Rect rect, Emugen.Image.Primitive.Color color, Emugen.OpenTK.View.IView view = null)
        {
            if (view==null)
            {
